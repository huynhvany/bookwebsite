...
<?php
  ...
  if(isset($_POST['create'])){
    ...
    $query = "INSERT INTO need_items(user_id, title, genre, author, price, contact, location)
              VALUES ('$user_id','$title', '$genre', '$author', '$price','$contact', '$location');";
    
    if(mysqli_query($conn, $query)){
      mysqli_close($conn); //Close connection
      echo("<script>location.href = '".ROOT_URL."users/user_need_items.php';</script>"); 
    } else {
...
<main class="colored-back-ground">
  ...
  <div>
      <a class="btn" href="<?php echo ROOT_URL;?>users/user_need_items.php">Back</a>
  </div>
  ...
  <div class="form-wrap full-page-option">
    ...
    <form method="POST" action=<?php echo $_SERVER['PHP_SELF']; ?>>
        ...
        <div class="form-group">
          ...
          <input type="number" step="0.1" name="price" value="0" >
        </div>
        <div class="form-group">
