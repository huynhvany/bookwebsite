...
<main>
  ...
  <div class="list-title">
    <h3>Your Needed Books</h3>
    <div>
          <a class="btn" href="<?php echo ROOT_URL;?>users/create_need.php">Create new post</a>
    </div>
  </div>
  ...
  <?php foreach($posts as $post): ?>
    <div class="list-item">
      ...
      <div class="list-item-options">
          <div>
            <a class="btn" href="<?php echo ROOT_URL; ?>users/edit_need.php?id=<?php echo $post['id'];?>">Edit</a>
          </div>
          <div>
            <a  class="btn" href="<?php echo ROOT_URL; ?>users/delete_need.php?id=<?php echo $post['id'];?>" >Delete</a>
          </div>
      </div>
    </div>
    <?php endforeach; ?>
