...
<main>
  ...
  <div class="list-title">
    ...
    <div>
          <a class="btn" href="<?php echo ROOT_URL;?>users/create_donate.php">Create new post</a>
    </div>
  </div>
  ...
  <?php foreach($posts as $post): ?>
    <div class="list-item">
      ...
      <div class="list-item-options">
        <div>
          <a class="btn" href="<?php echo ROOT_URL; ?>users/edit_donate.php?id=<?php echo $post['id'];?>">Edit</a>
        </div>
        <div>
          <a class="btn" href="<?php echo ROOT_URL; ?>users/delete_donate.php?id=<?php echo $post['id'];?>" >Delete</a>
        </div>
      </div>
    </div>
  <?php endforeach; ?>
